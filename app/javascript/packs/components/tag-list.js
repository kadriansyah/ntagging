...
class TagList extends PolymerElement {
    static get template() {
        return html`
            ...
            <paper-dialog class="card" id="form" modal>
                <tag-form action-url="[[dataUrl]]" form-authenticity-token="[[formAuthenticityToken]]" id="tagForm"></tag-form>
            </paper-dialog>
    ...
    _new() {
        this.$.tagForm.icon = 'icons:add';
        this.$.tagForm.title = 'Create New Tag';
        this.$.form.open();
    }

    _edit(e) {
        this.$.tagForm.icon = 'icons:create';
        this.$.tagForm.title = 'Edit Tag';
        this.$.tagForm.edit(e.target.id);
        this.$.progress.hidden = false;
    }
    ...
    _copy(e) {
        this.$.tagForm.icon = 'icons:content-copy';
        this.$.tagForm.title = 'Copy Tag';
        this.$.tagForm.copy(e.target.id);
        this.$.progress.hidden = false;
    }
